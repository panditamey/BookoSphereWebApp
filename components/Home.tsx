...
function Home() {
    return (
        <><a href="https://github.com/panditamey/BookoSphereApp" className="github-corner"
            ...
            <div className="pb-10 w-screen flex items-center justify-center max-md:flex-col bg-white">
                <div className="">
